...
PROJECTS = [
    {
        ...
        "client_role": "Owner, Spice Garden Restaurant",
        "client_review": "Saroj delivered a rock-solid system that our staff picked up in a day. Order and inventory tracking is flawless and the live sales dashboard helped us cut waste by 20%.",
        "client_rating": 5,
    },
    {
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Principal R. K. Thapa",
        "client_role": "Principal, Himalaya Public School",
        "client_review": "The grading and billing pipelines saved our admin team countless hours. The backend handles thousands of student records without a hiccup.",
        "client_rating": 5,
    },
    {
        ...
        "client_role": "Founder, SKM Tech",
        "client_review": "Our new site loads instantly and looks premium. Visitors immediately get what we do — conversions from the portfolio are up noticeably.",
        "client_rating": 5,
    },
    {
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Librarian S. Poudel",
        "client_role": "Head Librarian, City Central Library",
        "client_review": "Overdue alerts and search are lightning fast now. The Django backend Saroj built is the most reliable piece of software we run.",
        "client_rating": 5,
    },
    {
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Director N. Gupta",
        "client_role": "HR Director, Vertex Corp",
        "client_review": "Payroll and attendance that used to take days now run in minutes. The API design is clean and easy for our internal tools to consume.",
        "client_rating": 5,
    },
    {
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "CISO B. Maharjan",
        "client_role": "CISO, FinTrust",
        "client_review": "Security was non-negotiable for us. Saroj implemented RBAC and JWT rotation exactly to spec, and the session blocklist gives us real peace of mind.",
        "client_rating": 5,
    },
    {
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Ops Lead K. Shrestha",
        "client_role": "Operations Lead, Nimbus Bank",
        "client_review": "CKYC verification that was painfully manual is now fully automated and auditable. Throughput jumped and errors dropped to nearly zero.",
        "client_rating": 5,
    },
    {
        "title": "Nepal Handmade E-Commerce Storefront",
        "category": "Full Stack",
        "desc": "Multi-vendor marketplace with cart, Stripe payments, seller dashboards, and order fulfillment tracking for local artisans.",
        "tech": "Next.js | Django Rest Framework | PostgreSQL | Stripe",
        "image": "",
        "image_url": "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?q=80&w=1000&auto=format&fit=crop",
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Sita Bhandari",
        "client_role": "Founder, Himalayan Crafts",
        "client_review": "We now sell to customers across the country. The Stripe checkout is seamless and the seller dashboard makes managing inventory effortless.",
        "client_rating": 5,
    },
    {
        "title": "FitPulse Mobile App Backend",
        "category": "Mobile",
        "desc": "Scalable API powering a cross-platform fitness app: workout plans, progress sync, push notifications, and leaderboards.",
        "tech": "Python | Django | PostgreSQL | Firebase",
        "image": "",
        "image_url": "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=1000&auto=format&fit=crop",
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Anish Thapa",
        "client_role": "Product Lead, FitPulse",
        "client_review": "Saroj built an API that handles thousands of concurrent users without breaking a sweat. Push notifications and sync just work.",
        "client_rating": 5,
    },
    {
        "title": "Real-Time Team Chat Service",
        "category": "Backend",
        "desc": "WebSocket-based messaging platform with channels, presence, media sharing, and searchable message history at scale.",
        "tech": "Python | Django Channels | Redis | PostgreSQL",
        "image": "",
        "image_url": "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=1000&auto=format&fit=crop",
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Manager R. Joshi",
        "client_role": "Engineering Manager, CollabWorks",
        "client_review": "The real-time performance is outstanding. Channels and presence features shipped exactly as scoped and the code is a pleasure to maintain.",
        "client_rating": 5,
    },
    {
        "title": "CI/CD & Container Deployment Pipeline",
        "category": "DevOps",
        "desc": "Automated build, test, and zero-downtime deploy pipeline with Docker, GitHub Actions, and Nginx reverse proxy on cloud VMs.",
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "DevOps Lead H. Karki",
        "client_role": "DevOps Lead, CloudPeak",
        "client_review": "Deployments that took an afternoon now finish in minutes with zero downtime. The pipeline Saroj set up is rock solid.",
        "client_rating": 5,
    },
    {
        "title": "MediCare Appointment & Records API",
        "category": "Backend",
        "desc": "HIPAA-aware backend for clinic appointment scheduling, patient records, and doctor availability with role-based access.",
        ...
        "github": "https://github.com/s-k-m1",
        "demo": "",
        "client_name": "Dr. E. Rai",
        "client_role": "Clinic Director, MediCare",
        "client_review": "Appointment booking and records are now centralized and secure. The role-based access gives our staff exactly what they need and nothing more.",
        "client_rating": 5,
    },
]
